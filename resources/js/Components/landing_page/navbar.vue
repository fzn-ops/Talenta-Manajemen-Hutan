...
<template>
  <!-- Navbar -->
  <nav
    class="sticky top-0 z-50 w-full bg-[#4b857a] px-4 py-3.5 shadow-md sm:px-6 md:px-10 lg:px-16 xl:px-20"
  >
    <div class="flex items-center justify-between">
      ...
      <!-- Desktop Navigation -->
      <ul
        class="hidden flex-1 list-none items-center justify-center gap-5 md:flex lg:gap-8"
      >
        <li
        ...
        >
          ...
          >
            ...
            <span
              class="absolute -bottom-1 left-0 h-[2px] w-0 bg-white transition-all duration-300 ease-out group-hover:w-full"
            ></span>
          </a>
        </li>
      </ul>
