...
const menuItems = [
	{ label: 'Dashboard', href: '/admin/dashboard', pattern: 'admin.dashboard*', icon: 'dashboard' },
	{ label: 'Mahasiswa', href: '/admin/mahasiswa', pattern: 'admin.mahasiswa*', icon: 'mahasiswa' },
	{ label: 'Roadmap', href: '/admin/roadmap', pattern: 'admin.roadmap*', icon: 'roadmap' },
	{
		label: 'Aktivitas',
		href: '/admin/aktivitas',
		pattern: 'admin.aktivitas*',
		icon: 'aktivitas',
		hasChildren: true,
		children: [
	...
	{ label: 'Karir', href: '/admin/karir', pattern: 'admin.karir*', icon: 'karir' },
	{ label: 'Berita', href: '/admin/berita', pattern: 'admin.berita*', icon: 'berita' },
];
